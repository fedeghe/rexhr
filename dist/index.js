...
t.FormData&&u instanceof t.FormData||(y=o(y,{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"})),u=new URLSearchParams(u)),x.open(c,r,!0,s,i);for(var g in y)x.setRequestHeader(g,y[g])
...
}(rexhr,global||window),"object"==typeof exports&&(module.exports=rexhr);
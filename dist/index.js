...
var r=e.url,a=e.timeout||0,s=e.user||null,i=e.password||null,d=e.responseType,p=e.contentType,u=e.body||null,c=e.method,l=e.onCompleted||n,T=e.onLoad||n,f=e.onError||n,m=e.onAbort||n,E=e.onProgress||n,L=e.onLoadend||n,h=e.onLoadstart||n,v=e.onTimeout||n,y=e.headers||{},w=!!e.withCredentials,x=new XMLHttpRequest,C=!1
;if(x){x.responseType=d,x.withCredentials=w,x.timeout=a||null,x.addEventListener("load",T),x.addEventListener("progress",E),x.addEventListener("error",f),x.addEventListener("timeout",v),
...
;x.send(u)}return x};e.getJson=function(e){return r(o(e,{method:"GET",responseType:"json",contentType:"application/json"}))},e.getXML=function(e){return r(o(e,{method:"GET",responseType:"document",
